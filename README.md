 ...
 * **Model Selection**: I utilized **Gemini 1.5 Flash** for this POC to balance high-level intelligence with the low latency required for a real-time conversational interface.
